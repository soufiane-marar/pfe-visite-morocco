...
@Component({
  selector: 'app-shoppings-dialog',
  templateUrl: './shoppings-dialog.component.html',
  styleUrls: ['./shoppings-dialog.component.css']
})
export class ShoppingsDialogComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              ...
              public dialogRef: MatDialogRef<ShoppingsDialogComponent>,
              @Inject(MAT_DIALOG_DATA) public data: any) {
  }

  ngOnInit(): void {

    let hbg: any = this.data.shopping;
  ...
  private add(): void {
    ...
    this.shoppingsService.addShopping(body)
      .pipe(take(1))
      .subscribe(
        value => {
